  ...
  try
    ...
    begin
      ...
      begin
        ...
        TibiaTemporaryState.Container[C].Count := BMinMax(TibiaContainer942^[C].Count, 0,
          TibiaTemporaryState.Container[C].Capacity);
        for S := 0 to TibiaTemporaryState.Container[C].Count - 1 do
        begin
          TibiaTemporaryState.Container[C].Items[S].ID := TibiaContainer942^[C]
            .Items[S].ID;
          TibiaTemporaryState.Container[C].Items[S].Count := TibiaContainer942^[C]
            .Items[S].Count;
          TibiaTemporaryState.Container[C].Items[S].Amount := TibiaContainer942^[C].Items
            [S].Amount;
        end;
      end;
    end;
