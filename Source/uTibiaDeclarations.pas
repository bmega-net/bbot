...
const
  ...
  BotVerSupported: array [TibiaVerFirst .. TibiaVerLast] of BStr = ('8.50',
    '8.52', '8.53', '8.54', '8.55', '8.56', '8.57', '8.60', '8.61', '8.62',
    '8.70', '8.71', '8.72', '8.73', '8.74', '9.00', '9.10', '9.20', '9.31',
    '9.40', '9.41', '9.42', '9.43', '9.44', '9.45', '9.46', '9.50', '9.51',
    '9.52', '9.53', '9.54', '9.60', '9.61', '9.62', '9.63', '9.70', '9.71',
    '9.80', '9.81', '9.82', '9.83', '9.84', '9.8  5', '9.86', '9.90', '9.91',
    '9.92', '9.93', '9.94', '10.00', '10.01', '10.02', '10.10', '10.11',
    '10.12', '10.13', '10.20', '10.21', 'P10.21', '10.22', '10.30', '10.31',
    '10.32', '10.33', '10.34', '10.35', '10.36', '10.37', '10.38', '10.39',
    '10.40', '10.41', 'P10.41', '10.50', 'P10.50', '10.51', 'P10.51', '10.52',
    'P10.52', '10.53', 'P10.53', '10.54', '10.55', '10.56', '10.57', '10.58',
    '10.59', '10.60', '10.61', '10.62', '10.63', '10.64', '10.70', '10.71',
    '10.72', '10.73', '10.74', '10.75', '10.76', '10.77', '10.78', '10.79',
    'T10.81', '10.80', '10.81', '10.82', '10.90', '10.91', '10.92', '10.93',
    '10.94', '10.95', '10.96', '10.97', '10.98', '10.99', 'N10.00', '2N10.00',
    '3N10.00', '4N10.00', '5N10.00', '6N10.00',
    '7N10.00' { @@NEW_VERSION_SUPPORTED } );
  BotProcessAccess = PROCESS_TERMINATE or PROCESS_CREATE_THREAD or
...
type
  ...
  TTibiaMessageMode = (MESSAGE_NONE = 1, MESSAGE_SAY, MESSAGE_WHISPER,
    MESSAGE_YELL, MESSAGE_PRIVATE_FROM, MESSAGE_PRIVATE_TO,
    MESSAGE_CHANNEL_MANAGEMENT, MESSAGE_CHANNEL, MESSAGE_CHANNEL_HIGHLIGHT,
    MESSAGE_SPELL, MESSAGE_NPC_FROM_START_BLOCK, MESSAGE_NPC_FROM,
    MESSAGE_NPC_TO, MESSAGE_GAMEMASTER_BROADCAST, MESSAGE_GAMEMASTER_CHANNEL,
  ...
  TTibiaSkill = (SkillFirst = 1, SkillFist = SkillFirst, SkillClub, SkillSword,
    SkillAxe, SkillDistance, SkillShielding, SkillFishing, SkillMagic,
    SkillLast = SkillMagic);

  TTibiaSelfSkill = array [SkillFirst .. SkillLast] of BInt32;

  TTibiaSpecialSkill = (SpecialSkillFirst = 1, SpecialSkillCriticalHitChance,
    SpecialSkillCriticalHitAmount, SpecialSkillHpLeechChance,
    SpecialSkillHpLeechAmount, SpecialSkillManaLeechChance,
    SpecialSkillManaLeechAmount,
    SpecialSkillLast = SpecialSkillManaLeechAmount);

  TTibiaSelfSpecialSkill = array [SpecialSkillFirst .. SpecialSkillLast]
    of BInt32;

  TTibiaStatus = (tsPoisoned = 0, tsBurning, tsElectrified, tsDrunk,
    tsProtectedByMagicShield, tsParalysed, tsHasted, tsInBattle, tsDrowning,
    tsFreezing, tsDazzled, tsCursed, tsStrengthened,
    tsCannotLogoutOrEnterProtectionZone, tsWithinProtectionZone, tsBleeding,
    tsDeath, tsInvisible, tsLight, tsMounted);

  TTibiaSelfStatus = set of TTibiaStatus;

  TTibiaSlot = (SlotFirst = 1, SlotHead = SlotFirst, SlotAmulet, SlotBackpack,
    SlotArmor, SlotRight, SlotLeft, SlotLegs, SlotBoots, SlotRing, SlotAmmo,
    SlotPurseMarket, SlotPurseInbox, SlotLastClicked, SlotLast = SlotAmmo);
...
type
  ...
  TTibiaSkull = (SkullFirst = 0, SkullNone = SkullFirst, SkullYellow = 1,
    SkullGreen = 2, SkullWhite = 3, SkullRed = 4, SkullBlack = 5,
    SkullOrange = 6, SkullLast = SkullOrange);

  TTibiaCreatureKind = (CreaturePlayer = 0, CreatureMonster = 1,
    CreatureNPC = 2);
  ...
  TTibiaPartyPlayerClass = (PartyNone, PartyInvited, PartyMember, PartyLeader,
    PartyInviting, PartyOther);
  ...
  TTibiaDirection = (tdNorth = 0, tdEast = 1, tdSouth = 2, tdWest = 3,
    tdNorthEast = 4, tdSouthEast = 5, tdSouthWest = 6, tdNorthWest = 7,
    tdCenter = 8);
  ...
  TTibiaItemBotFlag = (idfRing, idfDepot, idfFood, idfCausesHostileExhaust,
    idfCausesDefensiveExhaust, idfCausesPotionExhaust, idfChangeLevelRope,
    idfChangeLevelShovel, idfChangeLevelLadder, idfChangeLevelUP,
    idfChangeLevelDown, idfChangeLevelHole, idfChangeLevel, idfTeleport,
    idfBotLast);
...
function TibiaInScreen(CenterX, CenterY, CenterZ, X, Y, Z: BInt32;
  ExtendedRange: BBool): BBool; overload;
function TibiaInScreen(ACenter, APosition: BPos; ExtendedRange: BBool)
  : BBool; overload;
...
begin
  Result := TibiaInScreen(ACenter.X, ACenter.Y, ACenter.Z, APosition.X,
    APosition.Y, APosition.Z, ExtendedRange);
end;
...
begin
  ...
  if BInRange(AID, Ord(PartyIDFirst), Ord(PartyIDLast)) then
  begin
    ...
    case ID of
      ...
      PartyIDMemberCantShare:
        begin
          Player := PartyMember;
          SharedDisabled := True;
        end;
      PartyIDLeaderCantShare:
        begin
          Player := PartyLeader;
          SharedDisabled := True;
        end;
      PartyIDMemberNoShared:
        begin
          Player := PartyMember;
        end;
      PartyIDLeaderNoShared:
        begin
          Player := PartyLeader;
        end;
      PartyIDOtherParty:
