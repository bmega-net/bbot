...
type
  ...
  TBBotCreatureList910Buffer = array [0 .. TibiaCreatureListSize - 1]
    of TBBotCreature910Buffer;
  ...
  public
    constructor Create(AIndex: BInt32; ABuffer: PBBotCreature910Buffer;
...
constructor TBBotCreature910.Create(AIndex: BInt32;
  ABuffer: PBBotCreature910Buffer; ACreatures: TBBotCreatures);
begin
...
procedure TBBotCreatures910.Write(ACreature: BUInt32; AOffset: BUInt32;
...
procedure TBBotCreatures910Mock.Write(ACreature: BUInt32; AOffset: BUInt32;
  AValue: BPtr; ASize: BUInt32);
begin
