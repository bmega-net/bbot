...
type
  ...
  TBBotCreatureList990Buffer = array [0 .. TibiaCreatureListSize - 1]
    of TBBotCreature990Buffer;
  ...
  public
    constructor Create(AIndex: BInt32; ABuffer: PBBotCreature990Buffer;
...
constructor TBBotCreature990.Create(AIndex: BInt32;
  ABuffer: PBBotCreature990Buffer; ACreatures: TBBotCreatures);
begin
...
procedure TBBotCreatures990.Write(ACreature: BUInt32; AOffset: BUInt32;
...
procedure TBBotCreatures990Mock.Write(ACreature: BUInt32; AOffset: BUInt32;
  AValue: BPtr; ASize: BUInt32);
begin
