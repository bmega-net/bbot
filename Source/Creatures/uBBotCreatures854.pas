...
type
  ...
  TBBotCreatureList854Buffer = array [0 .. TibiaCreatureListSize - 1]
    of TBBotCreature854Buffer;
  ...
  public
    constructor Create(AIndex: BInt32; ABuffer: PBBotCreature854Buffer;
...
constructor TBBotCreature854.Create(AIndex: BInt32;
  ABuffer: PBBotCreature854Buffer; ACreatures: TBBotCreatures);
begin
...
procedure TBBotCreatures854.Write(ACreature: BUInt32; AOffset: BUInt32;
...
procedure TBBotCreatures854Mock.Write(ACreature: BUInt32; AOffset: BUInt32;
  AValue: BPtr; ASize: BUInt32);
begin
...
begin
  ...
  CheckEquals(0, Creatures.Player.Outfit.Mount,
    'Version 854 does not have outfit.mount');
end;
