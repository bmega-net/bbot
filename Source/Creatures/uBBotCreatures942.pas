...
type
  ...
  TBBotCreatureList942Buffer = array [0 .. TibiaCreatureListSize - 1]
    of TBBotCreature942Buffer;
  ...
  public
    constructor Create(AIndex: BInt32; ABuffer: PBBotCreature942Buffer;
...
constructor TBBotCreature942.Create(AIndex: BInt32;
  ABuffer: PBBotCreature942Buffer; ACreatures: TBBotCreatures);
begin
...
procedure TBBotCreatures942.Write(ACreature: BUInt32; AOffset: BUInt32;
...
procedure TBBotCreatures942Mock.Write(ACreature: BUInt32; AOffset: BUInt32;
  AValue: BPtr; ASize: BUInt32);
begin
