...
type
  ...
  private
    ...
    function ReadKeyAndValue(const ALines: BStrArray; var ALine: BInt32;
      out AKey, AValue: BStr): BBool;
  ...
  protected
    procedure Configure(const AName, AComponentPath: BStr;
      const ATagID: BInt32); overload;
...
begin
  ...
  case ID of
    0:
      ID := ItemID_SmallHealthPotion;
    1:
      ID := ItemID_HealthPotion;
    2:
      ID := ItemID_StrongHealthPotion;
    3:
      ID := ItemID_GreatHealthPotion;
    4:
      ID := ItemID_GreatSpiritPotion;
    5:
      ID := ItemID_UltimateSpiritPotion;
    6:
      ID := ItemID_UltimateHealthPotion;
    7:
      ID := ItemID_SupremeHealthPotion;
    8:
      ID := ItemID_IntenseHealingRune;
    9:
      ID := ItemID_UltimateHealingRune;
  end;
...
begin
  ...
  case ID of
    0:
      ID := ItemID_ManaPotion;
    1:
      ID := ItemID_StrongManaPotion;
    2:
      ID := ItemID_GreatManaPotion;
    3:
      ID := ItemID_UltimateManaPotion;
    4:
      ID := ItemID_GreatSpiritPotion;
    5:
      ID := ItemID_UltimateSpiritPotion;
...
begin
  Configure('AdvancedAttack', 'AdvancedAttackFrame.AdvancedAttackList',
    -95160893);
  Configure('AttackSequences', 'AttackSequencesFrame.lstAttackSequences',
    -1122281310);

  Configure('BasicFeatures.AntiAfkKick', 'gbBasic.chkAntiIDLE', 619348825);
  Configure('BasicFeatures.AutoDropVials', 'gbBasic.chkAutoDropVials',
    1338316384);
  Configure('BasicFeatures.AutoEat', 'gbBasic.chkEat', -1764060782);
  Configure('BasicFeatures.AutoEatFromGround', 'gbBasic.chkEatFoodGround',
    1957225461);
  Configure('BasicFeatures.AutoMinimizeBPs.Enable', 'gbBasic.chkAutoMinimizeBP',
    -355221358);
  Configure('BasicFeatures.AutoMinimizeBPs.GetPremiumIsMinimized',
    'gbBasic.chkAutoMinimizeBPsMinimizedGetPremium', -1147830791);
  Configure('BasicFeatures.AutoMinimizeBPs.InventoryIsMinimized',
    'gbBasic.chkAutoMinimizeBPsInventory', -1703923302);
  Configure('BasicFeatures.AutoOpenBackpacks', 'gbBasic.chkAutoOpenBP',
    -1871498906);
  ...
  Configure('BasicFeatures.Fishing.MinCapacity', 'gbBasic.numFisherCap',
    -2113390);
  Configure('BasicFeatures.Fishing.NeedWorms', 'gbBasic.chkFishingWorm',
    406495769);
  Configure('BasicFeatures.FramerateLimiter', 'gbBasic.chkFrameRate',
    1237464721);
  ...
  Configure('BasicFeatures.ServerSave.Hour', 'gbBasic.numSSLogoutHH',
    -2002709616);
  Configure('BasicFeatures.ServerSave.Logout.Enable',
    'gbBasic.chkServerSaveLogout', 1082169595);
  Configure('BasicFeatures.ServerSave.Minute', 'gbBasic.numSSLogoutMM',
    -2051271846);
  ...
  Configure('Cavebot.WalkFurnitures', 'CavebotFrame.cmbWalkFurnitures',
    -803897836);
  ...
  Configure('Cavebot.WithdrawRounding', 'CavebotFrame.CavebotWithdrawRounding',
    -1472190810);
  Configure('Cavebot.SmartMapClick', 'CavebotFrame.SmartMapClick');

  Configure('Enchanter.BlankRunes', 'gbEnchanter.rbEnchanterUseBlank',
    -1537719137);
  ...
  Configure('FriendHealer.Enable', 'FriendHealerFrame.chkFHactive',
    -1208351215);
  ...
  Configure('Healer.Spell.Exhaust', 'HealerFrame.numHealerSpellsEx',
    -1879209382);

  Configure('Helaer.Item.High.Enable', 'HealerFrame.chkHealerItemHigh',
    -261822026);
  Configure('Healer.Item.High.HP', 'HealerFrame.numHealerItemHighHP',
    1972732859);
  Configure('Healer.Item.High.Item', 'HealerFrame.cmbHealerItemHigh', -61922353,
    MigrateHealerUse);
  Configure('Healer.Item.High.Percent', 'HealerFrame.chkHealerItemHighPercent',
    -1419931359);
  ...
  Configure('Healer.Item.Low.Enable', 'HealerFrame.chkHealerItemLow',
    664726982);
  Configure('Healer.Item.Low.HP', 'HealerFrame.numHealerItemLowHP',
    -1257914102);
  Configure('Healer.Item.Low.Item', 'HealerFrame.cmbHealerItemLow', -1169183731,
    MigrateHealerUse);
  Configure('Healer.Item.Low.Percent', 'HealerFrame.chkHealerItemLowPercent',
    1705233088);

  Configure('Healer.Spell.Low.Enable', 'HealerFrame.chkHealerSpellLow',
    -2143817111);
  Configure('Healer.Spell.Low.HP', 'HealerFrame.numHealerSpellLowHP',
    -112139308);
  Configure('Healer.Spell.Low.Mana', 'HealerFrame.numHealerSpellLowMana',
    267068155);
  Configure('Healer.Spell.Low.Percent', 'HealerFrame.chkHealerSpellLowPercent',
    -1958017710);
  Configure('Healer.Spell.Low.Spell', 'HealerFrame.edtHealerSpellLowSpell',
    -1399506541);

  Configure('Healer.Spell.Mid.Enable', 'HealerFrame.chkHealerSpellMid',
    1393655302);
  Configure('Healer.Spell.Mid.HP', 'HealerFrame.numHealerSpellMidHP',
    -12875631);
  Configure('Healer.Spell.Mid.Mana', 'HealerFrame.numHealerSpellMidMana',
    1485121280);
  Configure('Healer.Spell.Mid.Percent', 'HealerFrame.chkHealerSpellmidPercent',
    -1426447618);
  Configure('Healer.Spell.Mid.Spell', 'HealerFrame.edtHealerSpellMidSpell',
    -2035450878);

  Configure('Healer.Spell.High.Enable', 'HealerFrame.chkHealerSpellHigh',
    -1230307632);
  Configure('Healer.Spell.High.HP', 'HealerFrame.numHealerSpellHighHP',
    347220298);
  Configure('Healer.Spell.High.Mana', 'HealerFrame.numHealerSpellHighMana',
    -1684520157);
  Configure('Healer.Spell.High.Percent',
    'HealerFrame.chkHealerSpellHighPercent', -1246590074);
  Configure('Healer.Spell.High.Spell', 'HealerFrame.edtHealerSpellHighSpell',
    1362722921);

  Configure('Killer.Enable', 'KillerFrame.chkKillerAttackAll', 1398085848);
  Configure('Killer.AllowAttackPlayers',
    'KillerFrame.chkKillerAllowAttackPlayers', 1979633655);
  ...
  Configure('Looter.Looter.RusyRemover', 'LooterGroup.chkRustyRemover',
    1099918957);

  Configure('Looter.OpenCorpses.Enable', 'LooterGroup.chkLOpen', 1007361165);
  Configure('Looter.OpenCorpses.IgnoreCreatures',
    'IgnoreCorpsesGroup.OpenCorpsesIgnoreCreatures', -1672199181);
  Configure('Looter.OpenCorpses.Priority', 'LooterGroup.cmbLooterPrio',
    900540678);
  ...
  Configure('ManaTools.ManaDrinker.Variation',
    'ManaToolsFrame.ManaDrinkerVariation', 1005948850);

  Configure('ManaTools.ManaDrinker.High.Enable',
    'ManaToolsFrame.ManaDrinkerHigh', -476018121);
  Configure('ManaTools.ManaDrinker.High.PauseCavebot',
    'ManaToolsFrame.ManaDrinkerHighCavebot');
  Configure('ManaTools.ManaDrinker.High.FromMana',
    'ManaToolsFrame.ManaDrinkerHighFrom', 775323703);
  Configure('ManaTools.ManaDrinker.High.Percent',
    'ManaToolsFrame.ManaDrinkerHighPercent', 1432730617);
  Configure('ManaTools.ManaDrinker.High.ToMana',
    'ManaToolsFrame.ManaDrinkerHighTo', -1632580301);
  Configure('ManaTools.ManaDrinker.High.UseItem',
    'ManaToolsFrame.ManaDrinkerHighUse', 1696822118, MigrateManaDrinkerUse);

  Configure('ManaTools.ManaDrinker.Mid.Enable',
    'ManaToolsFrame.ManaDrinkerMid');
  Configure('ManaTools.ManaDrinker.Mid.PauseCavebot',
    'ManaToolsFrame.ManaDrinkerMidCavebot');
  Configure('ManaTools.ManaDrinker.Mid.FromMana',
    'ManaToolsFrame.ManaDrinkerMidFrom');
  Configure('ManaTools.ManaDrinker.Mid.Percent',
    'ManaToolsFrame.ManaDrinkerMidPercent');
  Configure('ManaTools.ManaDrinker.Mid.ToMana',
    'ManaToolsFrame.ManaDrinkerMidTo');
  Configure('ManaTools.ManaDrinker.Mid.UseItem',
    'ManaToolsFrame.ManaDrinkerMidUse');

  Configure('ManaTools.ManaDrinker.Low.Enable', 'ManaToolsFrame.ManaDrinkerLow',
    -1889191202);
  Configure('ManaTools.ManaDrinker.Low.PauseCavebot',
    'ManaToolsFrame.ManaDrinkerLowCavebot');
  Configure('ManaTools.ManaDrinker.Low.FromMana',
    'ManaToolsFrame.ManaDrinkerLowFrom', -1298759955);
  Configure('ManaTools.ManaDrinker.Low.Percent',
    'ManaToolsFrame.ManaDrinkerLowPercent', -1986894760);
  Configure('ManaTools.ManaDrinker.Low.ToMana',
    'ManaToolsFrame.ManaDrinkerLowTo', -630367521);
  Configure('ManaTools.ManaDrinker.Low.UseItem',
    'ManaToolsFrame.ManaDrinkerLowUse', -858062686, MigrateManaDrinkerUse);

  Configure('ManaTools.ManaTrainer.Enable', 'ManaToolsFrame.ManaTrainerEnable',
    -382233413);
  Configure('ManaTools.ManaTrainer.FromMana', 'ManaToolsFrame.ManaTrainerFrom',
    -429092993);
  Configure('ManaTools.ManaTrainer.Percent',
    'ManaToolsFrame.ManaTrainerPercent', 667599724);
  Configure('ManaTools.ManaTrainer.Spell', 'ManaToolsFrame.ManaTrainerSpell',
    -1830991425);
  Configure('ManaTools.ManaTrainer.ToMana', 'ManaToolsFrame.ManaTrainerTo',
    -931853780);
  Configure('ManaTools.ManaTrainer.Variation',
    'ManaToolsFrame.ManaTrainerVariation', 190570066);
  ...
  Configure('ReUSer.CureParalyzeSpell', 'gbReUserCures.edtCureParalyzeSpell',
    -1521597971);
  ...
  Configure('ReUser.CureEletrification', 'gbReUserCures.chkCureEletrification',
    -428543296);
  Configure('ReUser.CureParalyze', 'gbReUserCures.chkCureParalyze', 1908050152);
  Configure('ReUser.CurePatalyzeMana', 'gbReUserCures.numCureParalyzeMana',
    1769121443);
  ...
  Configure('ReUser.IntenseRecovery', 'gbReUserCures.chkRUintenserecovery',
    -230132051);
  ...
  Configure('ReUser.SharpShooter', 'gbReUserCures.chkRUsharpshooter',
    1706903759);
  ...
  Configure('SpecialSQMs.HUDEnable', 'SpecialSQMsFrame.SpecialSQMsShow',
    1991730000);
  Configure('SpecialSQMs.EditorHUDEnable',
    'SpecialSQMsFrame.SpecialSQMsEditorHUD');
  Configure('SpecialSQMs.Items', 'SpecialSQMsFrame.lstSpecialSQMs', 1619415883);

  Configure('TradeHelper.Trader.AdsChannel', 'gbTradeHelper.chkTHmsg',
    -2131311321);
  ...
  Configure('TradeHelper.Trader.Yell', 'gbTradeHelper.chkTHmsgyell',
    -793188046);
  ...
  Configure('War.AddNonPartyToEnemies', 'gbAlliesAndEnemies.chkEnemyNoAlly',
    496199039);
  Configure('War.AddPartyToAllies', 'gbAlliesAndEnemies.chkAllyParty',
    1010596051);
  ...
  Configure('War.AlliesEnemiesHUD',
    'gbAlliesAndEnemies.chkMarkAlliesAndenemies', -1455603792);
  Configure('War.AutoAttackEnemies', 'gbAlliesAndEnemies.chkAutoAttackEnemies',
    606065714);
  Configure('War.AutoPushParalyzedEnemies',
    'gbAlliesAndEnemies.chkPushParalyed', -1360263803);
  ...
  Configure('War.Combo.ParalyzedEnemies', 'gbWarbot.chkWCBparalyzed',
    -1920983814);
  ...
  Configure('War.MagicWallInFrontOfEnemies', 'gbWarbot.chkMWallFrontEnemies',
    -2064360622);
...
procedure TSettingsManager.Configure(const AName, AComponentPath: BStr;
  const ATagID: BInt32; const AMigrator: BUnaryFunc<BStr, BStr>);
var
...
function TSettingsManager.FindSettings(const AKey: BStr)
  : BVector<TSettingsRegister>.It;
var
  TagID: BInt32;
begin
...
begin
  ...
  if (BStrSplit(Lines, BStrLine, AData) > 0) and (Lines[0] = 'BBOT') then
  begin
    ResetForm;
    ...
    begin
      if ReadKeyAndValue(Lines, I, Key, Value) then
      begin
...
begin
  IterateComponentControls(Form,
    ...
    var
      Path: BStr;
    begin
      if (Component is TWinControl) and (Component.Tag <> 0) then
      begin
...
function TSettingsManager.ReadKeyAndValue(const ALines: BStrArray;
var ALine: BInt32; out AKey, AValue: BStr): BBool;
...
begin
  if BStrSplit(ALines[ALine], '=', AKey, AValue) then
  begin
    if BStrStartSensitive(AValue, '@M:') then
    begin
      MultilineMark := AValue;
      AValue := '';
      Inc(ALine);
      while (ALine < High(ALines)) and (ALines[ALine] <> MultilineMark) do
      begin
...
begin
  ...
  if ASetting.DefaultValue = Value then
    Exit('');
  if BStrPos(BStrLine, Value) > 0 then
  begin
...
function TSettingsManager.calculateComponentPath(const AComponent
  : TComponent): BStr;
