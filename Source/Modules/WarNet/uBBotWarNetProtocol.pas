...
const
  ...
  CMD_SERVER_ROOMS = CMD_SERVER_HELLO + 1;
  // SERVER NAME
  // SERVER PORT
  // ROOM_COUNT
  // ROOM_NAME
  ...
  CMD_SERVER_REMOVE = CMD_SERVER_ROOMS + 1;
  // NAME
  ...
  CMD_CLIENT_ROOMS = CMD_CLIENT_HELLO + 1;
  CMD_CLIENT_ROOM_JOIN = CMD_CLIENT_ROOMS + 1;
  // ROOMNAME
  // PLAYERNAME
  // PASSWORD
